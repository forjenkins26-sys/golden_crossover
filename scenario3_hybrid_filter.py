"""
SCENARIO 3: HYBRID FILTER (LONG filtered, SHORT unfiltered)
...
print("\n" + "="*200)
print("SCENARIO 3: HYBRID FILTER (LONG filtered, SHORT unfiltered)")
print("="*200)
...
if len(trades_df) > 0:
    ...
    trades_df.to_csv('scenario3_hybrid_filter.csv', index=False)
