"""
SCENARIO 1: RAW RSI (No Filters)
LONG: RSI < 30 (no filter)
...
print("\n" + "="*200)
print("SCENARIO 1: RAW RSI - NO FILTERS")
print("="*200)
...
if len(trades_df) > 0:
    ...
    trades_df.to_csv('scenario1_raw_rsi.csv', index=False)
