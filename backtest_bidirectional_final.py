...
print("LONG + SHORT with RSI + Bollinger Bands")
print("=" * 120)
...
for idx in range(len(df)):
    ...
    if open_trade:
        if open_trade['type'] == 'LONG':
            ...
            if price >= open_trade['tp2']:
                ...
                print(f"[{timestamp}] LONG TP2  @ ${exit_price:,.0f} | P&L: ${pnl_flat:+.2f}")
                open_trade = None
                compound_lot = LOT_SIZE
            ...
            # TP1 trailing stop
                ...
                if price <= open_trade['trail_sl']:
                    ...
                    print(f"[{timestamp}] LONG TP1_TRAIL @ ${exit_price:,.0f} | P&L: ${pnl_flat:+.2f}")
                    open_trade = None
                    compound_lot = LOT_SIZE
            ...
            # Hard SL
                ...
                print(f"[{timestamp}] LONG SL   @ ${exit_price:,.0f} | P&L: ${pnl_flat:+.2f}")
                open_trade = None
                compound_lot = LOT_SIZE
            ...
            if price <= open_trade['tp2']:
                ...
                print(f"[{timestamp}] SHORT TP2 @ ${exit_price:,.0f} | P&L: ${pnl_flat:+.2f}")
                open_trade = None
                compound_lot = LOT_SIZE
            ...
            # TP1 trailing stop
                ...
                if price >= open_trade['trail_sl']:
                    ...
                    print(f"[{timestamp}] SHORT TP1_TRAIL @ ${exit_price:,.0f} | P&L: ${pnl_flat:+.2f}")
                    open_trade = None
                    compound_lot = LOT_SIZE
            ...
            # Hard SL
                ...
                print(f"[{timestamp}] SHORT SL  @ ${exit_price:,.0f} | P&L: ${pnl_flat:+.2f}")
                open_trade = None
                compound_lot = LOT_SIZE
    ...
    if not open_trade and session_active:
        ...
        if rsi < RSI_LONG and price < bb_lower:
            ...
            print(f"[{timestamp}] LONG ENTRY  @ ${price:,.0f} | RSI:{rsi:5.1f}")
            compound_lot += LOT_SIZE
        ...
        # SHORT: RSI > 75 + Price > Upper BB
            ...
            print(f"[{timestamp}] SHORT ENTRY @ ${price:,.0f} | RSI:{rsi:5.1f}")
            compound_lot += LOT_SIZE
...
# Save to CSV
if trades:
    output_file = "backtest_bidirectional_final.csv"
    ...
    print(f"\n{'Direction':>10} {'Flat_Lots':>10} {'Cmpd_Lots':>10} {'Date_In':>12} {'Time_In':>8} {'Price_In':>12} {'Date_Out':>12} {'Price_Out':>12} {'Flat_P&L':>10} {'Status':>11} {'Session':>10}")
    print("-" * 120)
    for t in trades:
        print(f"{t['Direction']:>10} {t['Flat_Lots']:>10} {t['Cmpd_Lots']:>10} {t['Date_In']:>12} {t['Time_In']:>8} {t['Price_In']:>12} {t['Date_Out']:>12} {t['Price_Out']:>12} {t['Flat_P&L']:>10} {t['Status']:>11} {t['Session']:>10}")
